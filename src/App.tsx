    ...
    <div className="relative">
      ...
      <Routes>
        <Route element={<Layout />}>
          ...
          <Route
            path="/graphic-design/animated-graphics"
            element={<AnimatedGraphics />}
          />
          <Route
            path="/graphic-design/branding-and-social-media"
            element={<BrandingAndSM />}
          />
          <Route
            path="/graphic-design/stationary-and-events"
            element={<StationaryAndEvents />}
          />
          <Route
            path="/graphic-design/posters-and-ads"
            element={<PostersAndAds />}
          />
