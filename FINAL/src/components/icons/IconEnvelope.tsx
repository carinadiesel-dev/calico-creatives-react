...
export const IconEnvelope = ({ size = 1, ...rest }: IconEnvelopeProps) => {
  return <svg width={24 * size} height={24 * size} viewBox="0 0 24 24" fill="none" stroke='black' stroke-width="2" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg" {...rest}>
